...
export const mockProjects = [
    {
        ...
        description: 'Sentralisasi modul pelaporan untuk regulator (OJK & BI)',
    ...
    },
    {
        id: 'PRJ-2026-100',
        type: 'NON_RBB',
        typeLabel: 'Non-RBB (Fleksibel)',
        rbbDeadline: null,
        name: 'Aplikasi Manajemen Inventaris',
        description: 'Sistem pencatatan dan pelacakan aset IT internal.',
        division: 'Divisi TI',
    ...
    },
    {
        ...
        pm: { id: 2, name: 'Budi Santoso', initial: 'BS' },
        phase: 'Fase 4: Rilis',
        status: 'QUALITY_GATE',
    ...
    },
    {
        ...
        pm: { id: 3, name: 'Andi Pratama', initial: 'AP' },
    ...
    },
    {
        ...
        division: 'Divisi TI',
        pm: { id: 4, name: 'Rina Wati', initial: 'RW' },
        phase: 'Fase 2: Pengembangan',
        status: 'IN_DEVELOPMENT',
        statusColor: 'bg-indigo-100 text-indigo-700 border-indigo-200',
    ...
    },
    {
        ...
        description: 'Pengembangan integrasi Host-to-Host payment gateway untuk layanan merchant.',
        division: 'Divisi Perbankan Digital',
        pm: { id: 1, name: 'Budi Santoso', department: 'Divisi TI' },
        status: 'QA_PASSED',
    ...
    },
    {
        ...
        pm: { id: 2, name: 'Siti Aminah', department: 'Divisi TI' },
    ...
    },
    {
        ...
        pm: { id: 5, name: 'Dewi Lestari', initial: 'DL' },
        phase: 'Fase 3: Pengujian',
        status: 'CYBER_TESTING',
    ...
    },
    {
        ...
        pm: { id: 6, name: 'Fajar Hendra', initial: 'FH' },
        phase: 'Fase 2: Pengembangan',
        status: 'IN_DEVELOPMENT',
        statusColor: 'bg-indigo-100 text-indigo-700 border-indigo-200',
    ...
    },
    {
        ...
        division: 'Divisi TI',
        pm: { id: 7, name: 'Gilang Pratama', initial: 'GP' },
        phase: 'Fase 4: Rilis',
        status: 'UAT_PASSED',
    ...
    },
    {
        ...
        typeLabel: 'Non-RBB (Fleksibel)',
        rbbDeadline: null,
        name: 'Portal Layanan Nasabah Baru',
        description: 'Portal self-service nasabah untuk layanan umum',
        division: 'Divisi Layanan',
        pm: null,
        phase: 'Fase 1: Inisiasi',
        ...
        documents: [
            { name: 'BRD_PortalLayanan_v1.pdf', size: '1.5 MB', type: 'pdf' }
        ]
    },
    {
        id: 'PRJ-2026-102',
        ...
        description: 'Integrasi sistem untuk validasi KTP',
        division: 'Divisi Kepatuhan',
        pm: null,
        phase: 'Fase 1: Inisiasi',
        status: 'DEV_ANALYSIS_DONE',
...
export const kanbanTasks = [
    ...
    rbbDeadline: '2026-08-02',
        ...
        deadline: '2 days',
        subtasks: [
            { label: 'Setup database', done: true },
            { label: 'Configure API Gateway', done: false },
            { label: 'Deploy to staging', done: false },
        ],
        attachments: [
            { name: 'env-config.yml', size: '2 KB' },
            { name: 'api-spec.json', size: '15 KB' },
        ],
        comments: [
            { user: 'Budi Santoso', time: '2 jam lalu', text: 'Sudah siap untuk deployment?' },
            { user: 'Citra K', time: '1 jam lalu', text: 'Sudah, tinggal tunggu approval.' },
        ],
        timeEstimate: '2 days',
    },
    {
    ...
    type: 'NON_RBB',
    rbbDeadline: null,
        description: 'Define REST API specifications for customer onboarding flow.',
        status: 'Analisis',
        stage: 'analisis',
        priority: 'Medium',
        assignee: 'Andi W',
        ...
        deadline: '1 week',
        subtasks: [
            { label: 'Draft API spec', done: true },
            { label: 'Review with frontend team', done: true },
            { label: 'Finalize Swagger docs', done: false },
        ],
        attachments: [
            { name: 'swagger-draft.yaml', size: '12 KB' },
        ],
        comments: [
            { user: 'Andi W', time: '1 hari lalu', text: 'Menunggu feedback dari tim UI.' },
        ],
        timeEstimate: '1 week',
    },
    {
    ...
    type: 'RBB',
    rbbDeadline: '2026-08-02',
        description: 'Develop OAuth2 based authentication service with biometric support.',
        status: 'Pembangunan',
        stage: 'pembangunan',
        priority: 'High',
        assignee: 'Siska P',
        ...
        deadline: '3 weeks',
        subtasks: [
            { label: 'Setup OAuth2 Server', done: true },
            { label: 'Integrate biometrics SDK', done: false },
    ...
    type: 'NON_RBB',
    rbbDeadline: null,
        description: 'Perform integration testing on newly developed APIs.',
        status: 'Pengujian',
        stage: 'pengujian',
        priority: 'Medium',
        assignee: 'Rina W',
        projectName: 'Sistem Anti-Pencucian Uang',
        projectId: 'PRJ-2023-001',
        type: "RBB",
        rbbDeadline: "2026-08-02",
        deadline: '1 week',
        subtasks: [
            { label: 'Write test cases', done: true },
            { label: 'Execute automated tests', done: true },
            { label: 'Report bugs', done: false },
        ],
        attachments: [
            { name: 'test-plan.pdf', size: '1.2 MB' },
        ],
        comments: [
            { user: 'Rina W', time: '4 jam lalu', text: 'Test cases sudah siap, eksekusi akan dimulai besok.' },
        ],
        timeEstimate: '1 week',
    },
];
...
export const kanbanStages = [
    { id: 'inisiasi',
        type: 'RBB',
        rbbDeadline: '2026-08-02', label: 'Inisiasi', color: 'bg-slate-400' },
    { id: 'analisis',
        type: 'NON_RBB',
        rbbDeadline: null, label: 'Analisis', color: 'bg-blue-400' },
    { id: 'desain',
        type: 'RBB',
        rbbDeadline: '2026-08-02', label: 'Desain', color: 'bg-[#1A56DB]' },
    { id: 'pembangunan',
        type: 'NON_RBB',
        rbbDeadline: null, label: 'Pembangunan', color: 'bg-purple-400' },
    { id: 'pengujian',
        type: 'RBB',
        rbbDeadline: '2026-08-02', label: 'Pengujian', color: 'bg-orange-400' },
    { id: 'deployment',
        type: 'NON_RBB',
        rbbDeadline: null, label: 'Deployment', color: 'bg-green-400' },
];
...
export const users = [
    { id: 'USR-001', name: 'Budi Santoso',
    type: 'RBB',
    rbbDeadline: '2026-08-02', email: 'budi.santoso@banknagari.co.id', role: 'Project Manager', department: 'Divisi TI', status: 'Aktif', initial: 'BS', avatarBg: 'bg-tertiary-container/20' },
    { id: 'USR-002', name: 'Citra Kirana',
    type: 'NON_RBB',
    rbbDeadline: null, email: 'citra.kirana@banknagari.co.id', role: 'System Analyst', department: 'Divisi TI', status: 'Aktif', initial: 'CK', avatarBg: 'bg-secondary-container/20' },
    { id: 'USR-003', name: 'Dimas Anggara',
    type: 'RBB',
    rbbDeadline: '2026-08-02', email: 'dimas.anggara@banknagari.co.id', role: 'QA Tester', department: 'Divisi TI', status: 'Aktif', initial: 'DA', avatarBg: 'bg-error-container/20' },
    { id: 'USR-004', name: 'Rizal Pratama',
    type: 'NON_RBB',
    rbbDeadline: null, email: 'rizal.pratama@banknagari.co.id', role: 'Pentester', department: 'Divisi Kepatuhan', status: 'Aktif', initial: 'RP', avatarBg: 'bg-primary-container/20' },
    { id: 'USR-005', name: 'Siti Rahmawati',
    type: 'RBB',
    rbbDeadline: '2026-08-02', email: 'siti.rahmawati@banknagari.co.id', role: 'QA Automation', department: 'Divisi TI', status: 'Non-Aktif', initial: 'SR', avatarBg: 'bg-surface-variant' },
];
...
export const mockNotifications = [
    {
        id: 1,
        title: 'Proyek Baru Diajukan',
        message: 'Sistem Anti-Fraud Baru menunggu disposisi dari Lead Group.',
        type: 'info',
        isRead: false,
    ...
    },
    {
        ...
        message: 'Anda ditugaskan untuk mereview proyek Dashboard HRIS Internal.',
        type: 'success',
        isRead: false,
        createdAt: '2026-07-22T08:15:00',
        relatedUrl: '/workspace/analyst',
    },
    {
        id: 3,
        title: 'Pengajuan QA Selesai',
        message: 'Proyek Aplikasi LOS Baru telah selesai pengujian QA.',
        type: 'success',
        isRead: true,
        createdAt: '2026-07-21T16:45:00',
        relatedUrl: '/pm/qa-request',
    },
    {
        id: 4,
        title: 'Rilis Menunggu Approval',
        message: 'Aplikasi LOS Baru menunggu approval Quality Gate dari Head of IT.',
        type: 'warning',
        isRead: true,
        createdAt: '2026-07-21T14:20:00',
        relatedUrl: '/quality-gate',
    },
    {
        id: 5,
        title: 'Audit Keamanan Selesai',
        message: 'Audit keamanan untuk Update Core Banking API telah selesai.',
        type: 'info',
        isRead: true,
        createdAt: '2026-07-21T11:00:00',
        relatedUrl: '/my-tasks/cyber',
    },
];
